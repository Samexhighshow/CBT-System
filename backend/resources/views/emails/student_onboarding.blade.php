        ...
        <table role="presentation" width="620" cellspacing="0" cellpadding="0" style="max-width:620px;background:#ffffff;border:1px solid #e5e7eb;">
          ...
          <tr>
            <td style="padding:24px 28px;">
              <p style="margin:0 0 12px 0;font-size:15px;">Hello {{ $studentName }},</p>
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border:1px solid #e5e7eb;background:#f9fafb;margin:0 0 18px 0;">
                <tr>
                  ...
                  <td style="padding:12px 14px;font-size:14px;font-weight:700;color:#111827;">{{ $registrationNumber }}</td>
                </tr>
                <tr>
                  <td style="padding:12px 14px;font-size:13px;color:#6b7280;border-top:1px solid #e5e7eb;">Temporary Password</td>
                  <td style="padding:12px 14px;font-size:14px;font-weight:700;color:#111827;border-top:1px solid #e5e7eb;">{{ $defaultPassword }}</td>
                </tr>
              </table>
              ...
              <p style="margin:0 0 18px 0;">
                <a href="{{ $completeRegistrationUrl }}" style="display:inline-block;background:#2563eb;color:#ffffff;text-decoration:none;padding:10px 16px;font-size:14px;font-weight:700;">
