        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="p-6 bg-yellow-50 rounded-xl hover:shadow-lg transition">
              ...
              <p className="text-gray-600">Countdown timer with auto-submit. Visual warnings at critical time.</p>
            </div>
            ...
            <div className="p-6 bg-red-50 rounded-xl hover:shadow-lg transition">
              ...
              <p className="text-gray-600">Automatic scoring with detailed analytics and performance reports.</p>
            </div>
            ...
            <div className="p-6 bg-indigo-50 rounded-xl hover:shadow-lg transition">
              ...
              <p className="text-gray-600">Admin, Teachers, and Students with granular permission control.</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8 text-center text-white">
            ...
            <div>
              ...
              <div className="mt-2 text-blue-100">Exams Conducted</div>
            </div>
            <div>
      ...
      <div className="py-20">
        <div className="max-w-4xl mx-auto text-center px-4">
          ...
          <p className="text-xl text-gray-600 mb-8">
            Join thousands of students already using our platform for their examinations.
          </p>
          <Link
            to="/register"
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-white font-semibold mb-4">CBT System</h3>
              <p className="text-sm">Modern examination platform for schools</p>
            </div>
            <div>
